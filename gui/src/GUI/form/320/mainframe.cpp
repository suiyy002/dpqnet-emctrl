...
void CMainFrame::InitComponent()
{
    ...
    int phs_tab_height = 13;
    int label_help_height = 14;
    ...
    //电池电量指示
    battery_indicator = new CBattery(8, 5);
    battery_indicator->set_position(188, 4);
    ...
    plabel->top = height_ - label_help->height;
    plabel->left = left;
